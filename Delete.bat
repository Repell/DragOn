...
rmdir /s /q .\Engine\Engine_Resources\Include\Debug
rmdir /s /q .\Engine\Engine_System\Include\Debug
rmdir /s /q .\Engine\Engine_Utility\Include\Debug

del /f /q .\Client\Bin\Client.exe
del /f /q .\Client\Bin\Client.ilk
del /f /q .\Client\Bin\Client.pdb
del /f /q Frame94.VC.db
